...
const email_verification_token_entity_1 = require("../../auth/entities/email-verification-token.entity");
let User = class User {
};
exports.User = User;
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => user_session_entity_1.UserSession, userSession => userSession.user),
    __metadata("design:type", Array)
], User.prototype, "userSessions", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => password_reset_token_entity_1.PasswordResetToken, passwordResetToken => passwordResetToken.user),
    __metadata("design:type", Array)
], User.prototype, "passwordResetTokens", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => email_verification_token_entity_1.EmailVerificationToken, (t) => t.user),
    __metadata("design:type", Array)
