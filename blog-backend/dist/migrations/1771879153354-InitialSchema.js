...
exports.InitialSchema1771879153354 = void 0;
class InitialSchema1771879153354 {
    constructor() {
        this.name = 'InitialSchema1771879153354';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying(100), "lastName" character varying(100), "username" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "password" character varying(255) NOT NULL, "avatar" character varying(100), "coverImage" character varying(100), "bio" character varying(100), "isActive" boolean NOT NULL DEFAULT true, "email_verified_at" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
...
exports.InitialSchema1771879153354 = InitialSchema1771879153354;
//# sourceMappingURL=1771879153354-InitialSchema.js.map