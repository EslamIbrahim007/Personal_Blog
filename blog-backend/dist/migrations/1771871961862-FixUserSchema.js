...
exports.FixUserSchema1771871961862 = void 0;
class FixUserSchema1771871961862 {
    constructor() {
        this.name = 'FixUserSchema1771871961862';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "coverImage" DROP NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "coverImage" SET NOT NULL`);
...
exports.FixUserSchema1771871961862 = FixUserSchema1771871961862;
//# sourceMappingURL=1771871961862-FixUserSchema.js.map